...
const CardMovie = (props) => {
  ...
  return (
    <div class="movie-item c-card block bg-white shadow-md hover:shadow-xl rounded-lg overflow-hidden">
      <div class="relative pb-48 overflow-hidden">
        <img
          class="image absolute inset-0 h-full w-full object-cover"
      ...
      <div class="p-4">
        ...
        <p class="text-sm description">{overview}</p>
      </div>
      ...
      <div class="p-4 flex items-center text-sm text-gray-600">
        <span class="mr-auto">Vote: {vote_count || 0}</span>
        {[...Array(5)].map((v, i) => {
